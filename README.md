...
- [JavaScript Rendering Library/Frameworks](#javascript-rendering-library-frameworks)
  * [Node frameworks](#node-frameworks)
  * [Svelte - compiles app to pure JS code](#svelte---compiles-app-to-pure-js-code)
  * [gatsby - static site generator](#gatsby---static-site-generator)
...
- [JavaScript Libraries](#javascript-libraries)
  * [VX - react + d3](#vx---react---d3)
  * [trousers - styled components](#trousers---styled-components)
  * [react-spring](#react-spring)
  * [react-motion](#react-motion)
  * [Styletron - CSS in JS](#styletron---css-in-js)
  * [Emotion - CSS in JS](#emotion---css-in-js)
  * [RxJS - event streams](#rxjs---event-streams)
  * [mitt - tiny functional event emitter](#mitt---tiny-functional-event-emitter)
  * [parket - state management](#parket---state-management)
  * [faker.js - generate fake data](#fakerjs---generate-fake-data)
  * [turbo - parallel computation](#turbo---parallel-computation)
  * [imagemin](#imagemin)
- [Languages](#languages)
...
- [Mobile](#mobile)
  ...
  * [Cordova](#cordova)
  * [Bazel - building and testing Android apps](#bazel---building-and-testing-android-apps)
- [Testing](#testing)
  * [Ava - unit testing library](#ava---unit-testing-library)
  * [Jest - unit testing framework](#jest---unit-testing-framework)
  * [RITEway - unit testing framework](#riteway---unit-testing-framework)
  * [Karma - E2E testing framework](#karma---e2e-testing-framework)
  * [Mocha - unit & E2E testing framework](#mocha---unit---e2e-testing-framework)
  * [Jasmine - unit testing framework](#jasmine---unit-testing-framework)
  * [Chai - unit & E2E test assertion library](#chai---unit---e2e-test-assertion-library)
  * [Sinon - test spies, stubs and mocks](#sinon---test-spies--stubs-and-mocks)
  * [Cucumber and Gherkin - Behaviour Driven Development (BDD) testing](#cucumber-and-gherkin---behaviour-driven-development--bdd--testing)
  * [TestCafe - E2E testing framework and tool](#testcafe---e2e-testing-framework-and-tool)
  * [Cypress - E2E testing framework and tool](#cypress---e2e-testing-framework-and-tool)
  * [CodeceptJS - E2E framework with different engines](#codeceptjs---e2e-framework-with-different-engines)
  * [Webdriverio - WebDriver test framework](#webdriverio---webdriver-test-framework)
  * [Selenium WebDriver - cross browser testing](#selenium-webdriver---cross-browser-testing)
  * [PhantomJS - headless browser](#phantomjs---headless-browser)
  * [Protractor - E2E Engine](#protractor---e2e-engine)
  * [Puppeteer - E2E Engine](#puppeteer---e2e-engine)
  * [NightmareJS - E2E Engine](#nightmarejs---e2e-engine)
  * [Pact - Consumer Driven Contract testing](#pact---consumer-driven-contract-testing)
  * [Stryker - multation testing](#stryker---multation-testing)
  * [Allure Framework - test reporter](#allure-framework---test-reporter)
- [GitHub Projects](#github-projects)
  * [Serverless - framework for serverless apps](#serverless---framework-for-serverless-apps)
- [Tools & Services](#tools---services)
  ...
  * [Squoosh](#squoosh)
  * [now.sh - deploy serverless application](#nowsh---deploy-serverless-application)
  * [Keybase - an free Slack alternative](#keybase---an-free-slack-alternative)
  * [Garden - testing Kubernetes applications](#garden---testing-kubernetes-applications)
  * [CloudFlare Workers - serverless hosting](#cloudflare-workers---serverless-hosting)
  * [browserl.ist - compatible checker](#browserlist---compatible-checker)
  * [pikapkg - use npm packages in browser](#pikapkg---use-npm-packages-in-browser)
  * [Pika - NPM alternative](#pika---npm-alternative)
  * [Pika - Monorepo](#pika---monorepo)
  * [minimal analytics](#minimal-analytics)
  * [bit - create component libraries](#bit---create-component-libraries)
  * [Web Measure](#web-measure)
  * [Renovate - Github tool](#renovate---github-tool)
  * [LogRocket](#logrocket)
- [Miscellaneous](#miscellaneous)
  ...
  * [asciinema - terminal session recorder](#asciinema---terminal-session-recorder)
  * [DaVinci Resolve 16 - free video editing software](#davinci-resolve-16---free-video-editing-software)
  * [flotato - turn web into mac apps](#flotato---turn-web-into-mac-apps)
  * [Launchaco - generate logos](#launchaco---generate-logos)
  * [Mark Text - markdown editor](#mark-text---markdown-editor)
  * [imageoptim - image optimiser](#imageoptim---image-optimiser)
  * [Design System Galary](#design-system-galary)
...
+ ### Cucumber and Gherkin - Behaviour Driven Development (BDD) testing
...
+ ### Allure Framework - test reporter
